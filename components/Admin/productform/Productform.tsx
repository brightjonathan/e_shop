...
export default function Productform({
  ...
  const salePrice =
    discountPercentage > 0 ? product.price - (product.price * discountPercentage) / 100 : null;
            ...
            <div className={styles.row}>
              <div className={styles.inputGroup}>
                ...
                <input
                  ...
                  max="100"
                  step="1"
                  value={discountPercentage ? discountPercentage.toString() : ""}
                  onChange={handleDiscountChange}
                />
                {salePrice !== null && (
                  <p style={{ fontSize: 12, color: "#34d399", marginTop: 6 }}>
                    Sale price: ₦{salePrice.toLocaleString("en-NG", { maximumFractionDigits: 2 })}{" "}
              ...
              <div className={styles.inputGroup}>
                <label className={styles.label}>
                  <span className={styles.labelIcon}>🔢</span>
                  SKU <span style={{ fontWeight: 400, opacity: 0.6, marginLeft: 4 }}>(optional)</span>
                </label>
                <input
                  className={styles.input}
                  type="text"
                  placeholder="e.g. NIKE-AM270-BLK-42"
                  value={product.sku ?? ""}
